...
per-invocation delta** of its bundled [lens-frame](lens-frame.md) §bundle contract: the `target` —
...
attribution envelope per the [handoff-prompt-convention](handoff-prompt-convention.md)
grammar, verbatim:
