...
- **Small surface area** — the deep module: a small interface over substantial implementation. What shape a module and its seam should take is [architecture-doctrine](../../../references/architecture-doctrine.md)'s question; this card owns test quality.
