...
[bindings](../../../references/bindings-contract.md)). It carries no decision content of its own; it fixes the shape every consumer
...
([gate-model](../../../references/gate-model.md)). This is the cross-cutting store of **settled design decisions**, durable and
...
- **The carrier's gate ledger** `gate_decisions[]` — the hash-chained per-carrier gate log, a different thing → [gate-model](../../../references/gate-model.md).
- **The store path** (`decisions_store_path`) the harness binds → [bindings-contract](../../../references/bindings-contract.md).
